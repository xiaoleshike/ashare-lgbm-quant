            ...
            universe_rows.append(
                {
                    ...
                    "list_days": 1000,
                    "is_listed": True,
                    "lifecycle_state": ("ORDINARY_SUSPENSION" if is_suspended else "ACTIVE"),
                    "is_ordinary_suspended": is_suspended,
                    "is_listing_suspended": False,
                    "is_terminal": False,
                    "is_new_stock": False,
                    "is_st": False,
